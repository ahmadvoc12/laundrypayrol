      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <!-- Map card -->
            <div class="card">
              <div class="card-header"> data cabang</h3>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a onclick="return confirm('apakah anda yakin ingin menghapus cabang ini?')" href="<?=base_url('admin/departemen_delete/'.$d->departemen_id)?>" class="btn btn-sm btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                      </td>
                    </tr>
                    <?php } ?>
                  </tbody>
