...
class Admin extends CI_Controller {
	...
	public function departemen_simpan()
	{
		...
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Tambah Cabang", "success");');
	...
	public function departemen_update($id)
	{
		...
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Update Cabang", "success");');
		redirect('admin/departemen');
	...
	public function departemen_delete($id)
	{
		...
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Delete Cabang", "success");');
		redirect('admin/departemen');
	...
	public function pegawai_simpan()
	{
		...
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Tambah Data karyawan", "success");');
	...
	public function pegawai_update($id)
	{
		...
		$this->db->trans_complete();
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Update Data karyawan", "success");');
		redirect('admin/pegawai');
	}
	public function pegawai_delete($id)
	{
		...
		$this->db->trans_complete();
		$this->session->set_flashdata('message', 'swal("Berhasil!", "Delete Data karyawan", "success");');
		redirect('admin/pegawai');
	}
	//end CURD pegawai
	//Data Absensi
	...
	public function detailspenggajian($id)
	{
		$data['list']	= $this->M_data->pegawaiid($id)->result();
		$data['web']	= $this->web;
		$data['title']	= 'Penggajian Karyawan';
		$data['body']	= 'admin/penggajian_details';
		$this->load->view('template',$data);
	}

	public function slip1($id)
	{
		$data['list']	= $this->M_data->pegawaiid($id)->result();
		$data['web']	= $this->web;
		$data['title']	= 'Penggajian Karyawan';
	...
	public function cetak_slip1($id)
	{
		$data['list']	= $this->M_data->pegawaiid($id)->result();
		$data['web']	= $this->web;
		$data['title']	= 'Penggajian Karyawan';
		$data['body']	= 'admin/cetak_slip1';
		$this->load->view('template',$data);
	}
}
